...
bool Workflow::SetUpOpt (int argc, char** argv) {
    ...
    "libGaze", "lib for gaze detection using simd intrsutions");
    options.positional_help ("[optional args]").show_positional_help ();
    options.allow_unrecognised_options ().add_options () ("input_temp",
    "input harcascade template",
    cxxopts::value<std::string> ()->default_value (
    "../../data/template/haarcascade_frontalface_default.xml")) ("input_vid",
    "input video path", cxxopts::value<std::string> ()->default_value (
                        "../../data/vids/VID_20181007_154019.mp4")) (
    "drawFaces", "is drawer should draw faces",
    cxxopts::value<bool> ()->default_value ("true")) ("drawEyes",
    "is drawer shoud draw eyes",
    cxxopts::value<bool> ()->default_value ("true")) ("showImg",
    "is drawer should show img",
